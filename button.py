...
class Button(GameObject):
    def __init__ (self, x, y, w, h, button_normal_back_color, text, on_click = lambda x: None, padding = 0):
        ...
        self.text = TextObject(self.centerx, self.centery, lambda: text, c.button_text_color, c.button_font_name, c.button_font_size)
    ...
    @property
    def back_color(self):
        return {'normal': self.button_normal_back_color, 'hover': c.button_hover_back_color, 'pressed': c.button_pressed_back_color}[self.state]
